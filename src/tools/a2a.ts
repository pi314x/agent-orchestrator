import { z } from 'zod';
import { cardMatchesSkill, endpointFor } from '../a2a/card.js';
    ...
    server.registerTool(
      ...
      async () => {
        ...
        const card = await buildAgentCard({
          ...
          ...(deps.services.pqc.cardSigner !== undefined && { pqcSigner: deps.services.pqc.cardSigner })
        });
